...
{
    [ProtoContract]
    public record ZonePositionHistoryEvent : SystemBaseEvent
    {
        [ProtoMember(1)] public string ZoneId { get; set; }
        [ProtoMember(2)] public ZonePositionHistoryItemEvent[]? ZonePositionsOld { get; set; }
        [ProtoMember(3)] public ZonePositionHistoryItemEvent[]? ZonePositionsNew { get; set; }
        //[ProtoMember(4)] public string Command { get; set; }
        [ProtoMember(5)] public string ChangeId { get; set; }
        [ProtoMember(6)] public bool IsAuto { get; set; }
    }

    [ProtoContract]
    public record ZonePositionHistoryItemEvent : SystemBaseEvent
    {
